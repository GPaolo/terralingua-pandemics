...
class SimulationRunner:
    ...
    def _make_env(self):
        ...
        self.env = OpenGridWorld(
            ...
            funeral_announcement_radius=self.params.env.funeral_announcement_radius,
            funeral_attendance_multiplier=self.params.env.funeral_attendance_multiplier,
            funeral_mourning_days=self.params.env.funeral_mourning_days,
